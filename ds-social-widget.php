 ...
 * License URI: #
 *
 * @package ds-social-widget
 */

// Stops someone accessing this page from the browser 
 if ( ! defined('ABSPATH') ) {
     die;
 }

// Define variable for path to this plugin file
 define( 'ds_LOCATION', __DIR__ );
 define( 'ds_LOCATION_URL', __DIR__ );

/**
 * 
 * Enqueues stylesheets
 */
function ds_user_scripts() {
	$plugin_url = plugin_dir_url( __FILE__ );

wp_enqueue_style( 'style',  $plugin_url . "pluginStyles.css");

wp_enqueue_style( 'load-fa', 'https://use.fontawesome.com/releases/v5.5.0/css/all.css' );
}

add_action( 'admin_print_styles', 'ds_user_scripts' );
...
add_filter( 'ds_social_profiles', 'ds_register_default_social_profiles', 10, 1 );
...
add_action( 'customize_register', 'ds_register_social_customizer_settings' );
...
add_action( 'widgets_init', 'ds_register_social_icons_widget' );

/**
 * Extend the widgets class for our new social icons widget.
 */
class ds_Social_Icons_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$control_ops = array(
			'id_base' => 'ds_social_icons',
		);

		/* Create the widget. */
		parent::__construct( 'ds_social_icons', 'Social Icons', $widget_ops, $control_ops );
    ...
    public function widget( $args, $instance ) {
         ...
         */
        do_action( 'ds_social_icons_widget_output', $args, $instance );
 ...
 */
function ds_social_icons_output_widget_title( $args, $instance ) {
...
add_action( 'ds_social_icons_widget_output', 'ds_social_icons_output_widget_title', 10, 2 );
 ...
 * @param  array $instance The current instance of widget data.
 */
function ds_output_social_icons_widget_content( $args, $instance ) {
...
add_action( 'ds_social_icons_widget_output', 'ds_output_social_icons_widget_content', 20, 2 );